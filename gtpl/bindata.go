...
var _commentMd = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\xe2\x52\x2d\x56\xc8\xcf\x53\x28\xc9\xc8\x2c\x56\x48\xad\x48\x2d\x4a\xce\x2c\x4e\xb5\x02\x04\x00\x00\xff\xff\x8f\x03\x06\xcf\x15\x00\x00\x00")

func commentMdBytes() ([]byte, error) {
	return bindataRead(
		_commentMd,
		"comment.md",
	)
...
func commentMd() (*asset, error) {
	bytes, err := commentMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "comment.md", size: 21, mode: os.FileMode(420), modTime: time.Unix(1538311404, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"comment.md":           &bintree{commentMd, map[string]*bintree{}},
