...
func toolsNot_formattedMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "tools/not_formatted.md", size: 354, mode: os.FileMode(420), modTime: time.Unix(1542985381, 0)}
...
func toolsNot_lintedMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "tools/not_linted.md", size: 523, mode: os.FileMode(420), modTime: time.Unix(1542985381, 0)}
...
func toolsPass_testsMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "tools/pass_tests.md", size: 497, mode: os.FileMode(420), modTime: time.Unix(1542985381, 0)}
