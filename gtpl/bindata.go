...
func topicHintsMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "topic/hints.md", size: 2774, mode: os.FileMode(0644), modTime: time.Unix(1555874498, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x9d, 0xdf, 0xbc, 0xbe, 0x61, 0xda, 0xcb, 0x6b, 0x9e, 0x83, 0x2a, 0xc9, 0xab, 0x12, 0xd6, 0x42, 0xdf, 0xd3, 0xb, 0x85, 0x6c, 0x8c, 0x12, 0x6b, 0xb, 0xe7, 0x2b, 0xe7, 0x25, 0xe0, 0xdf, 0x55}}
	return a, nil
}
