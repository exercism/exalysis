...
var containsWhiteSpace = regexp.MustCompile("\\s")
var digitsOnly = regexp.MustCompile("^[0-9]{2,}$")
...
func Valid(str string) bool {
	s := containsWhiteSpace.ReplaceAllString(str, "")
	isInputValid := digitsOnly.MatchString(s)
