...
func mustcompileMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "mustcompile.md", size: 168, mode: os.FileMode(420), modTime: time.Unix(1544959002, 0)}
...
func oneLoopMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "one-loop.md", size: 1862, mode: os.FileMode(420), modTime: time.Unix(1544959002, 0)}
...
func regexInFuncMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "regex-in-func.md", size: 307, mode: os.FileMode(420), modTime: time.Unix(1544959002, 0)}
...
func regexToFastMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "regex-to-fast.md", size: 1884, mode: os.FileMode(420), modTime: time.Unix(1544959002, 0)}
