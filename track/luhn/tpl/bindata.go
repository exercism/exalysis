...
func oneLoopMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "one-loop.md", size: 1534, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
...
func regexInFuncMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "regex-in-func.md", size: 306, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
...
func regexToFastMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "regex-to-fast.md", size: 1613, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
