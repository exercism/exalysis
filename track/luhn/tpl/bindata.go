...
func oneLoopMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "one-loop.md", size: 1731, mode: os.FileMode(420), modTime: time.Unix(1542985381, 0)}
...
func regexInFuncMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "regex-in-func.md", size: 307, mode: os.FileMode(420), modTime: time.Unix(1542985381, 0)}
...
func regexToFastMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "regex-to-fast.md", size: 1753, mode: os.FileMode(420), modTime: time.Unix(1542985381, 0)}
