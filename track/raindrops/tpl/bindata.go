...
func concatNotNeededMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "concat-not-needed.md", size: 95, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
...
func itoaMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "itoa.md", size: 98, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
