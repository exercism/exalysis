...
func concatNotNeededMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "concat-not-needed.md", size: 77, mode: os.FileMode(420), modTime: time.Unix(1538928658, 0)}
...
func manyLoopsMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "many-loops.md", size: 146, mode: os.FileMode(420), modTime: time.Unix(1538926916, 0)}
