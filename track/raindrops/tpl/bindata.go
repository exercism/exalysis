...
func concatNotNeededMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "concat-not-needed.md", size: 95, mode: os.FileMode(420), modTime: time.Unix(1542132321, 0)}
...
func fmtPrintMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "fmt-print.md", size: 149, mode: os.FileMode(420), modTime: time.Unix(1542180758, 0)}
...
func itoaMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "itoa.md", size: 98, mode: os.FileMode(420), modTime: time.Unix(1542132321, 0)}
