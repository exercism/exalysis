...
var suggestTests = []struct {
	...
	{path: "./solutions/1", suggestion: tpl.WaitGroupRangeChan, expected: false},
	...
	{path: "./solutions/2", suggestion: tpl.WaitGroupRangeChan, expected: false},
	...
	{path: "./solutions/8", suggestion: tpl.WaitGroupRangeChan, expected: true},
