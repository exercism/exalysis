...
func basicFloat64Md() (*asset, error) {
	...
	info := bindataFileInfo{name: "basic-float64.md", size: 334, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
...
func calcRangeConditionMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "calc-range-condition.md", size: 200, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
...
func dryMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "dry.md", size: 215, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
...
func squareSumLoopMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "square-sum-loop.md", size: 167, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
...
func sumSquareLoopMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "sum-square-loop.md", size: 187, mode: os.FileMode(420), modTime: time.Unix(1542542807, 0)}
